...
const BodyImagePart = () => {
  ...
  <div
    ...
    className="h-screen bg-contain bg-no-repeat bg-center flex justify-center items-center  pr-0 sm:pr-8 "
      >
        <img src={nerves} alt="nerves"   data-aos="fade-in" className='h-[150%] sm:h-[80%] w-full'/>
    {/* Nerve Image */}
    {/* <div className="w-[60%]">
