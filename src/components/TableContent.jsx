...
const ScheduleTable = () => {
  return (
    <div className="overflow-x-auto pt-4 max-md:overflow-x-scroll">
      <table className="min-w-full border-collapse border bg-[#FFDE59] border-black text-sm text-left sm:text-xs md:text-sm lg:text-base ">
        <thead>
