...
const Home = () => {
    return (
      <div className='main w-full'>
            ...
            <div className='flex flex-col lg:flex-row items-center'>
              ...
              <div className='w-full lg:w-1/2 xl:w-2/3 p-4'>
                <p className='text-lg text-black'>
                  <span className='text-6xl'>T</span>rauma is the most
                  unaddressed and invisibilized epidemic in today’s time. 7 out
                  of 10 children in India experience some form of adversity at
                  an early age. If left unaddressed, these painful experiences
                  can haunt them for the rest of their lives leaving a deep
                  impact on their mental, emotional, and physical wellbeing.
                  <br />
                  <br />
        ...
        <section className='section about-us py-16'>
          <div className='container mx-auto'>
            <div className='flex flex-wrap items-center justify-between '>
              ...
              <div className='lg:w-4/12 xl:w-5/12 xl:offset-xl-2  mt-10  flex flex-col  '>
                ...
                <div className='lg:mb-6  mb-6'>
                  <div className='counter-item flex flex-col gap-2 text-center'>
                    <div className='counter-item__lower'>
                      <span className='js-counter text-6xl font-bold mr-10'>
                        3346
                      </span>
                    </div>
                    <div className='counter-item__top ml-6'>
                ...
                <div className='text-center flex flex-col '>
                  <div className='counter-item counter-item--style-1'>
                    <div className='counter-item__lower '>
                      <span className='js-counter text-6xl font-bold'>
                        100844
                      </span>
                    </div>
        ...
        <section
          className='section elements bg-yellow-300 relative h-[100px] lg:[180px]'
          style={{
        ...
        <section
          className='section elements bg-yellow-300 h-[100px]  relative'
          style={{
            backgroundImage: `url(${bg})`,
            backgroundPosition: "bottom left",
            backgroundSize: "100% auto",
